...
export default function handler(req, res) {
  ...
  res.status(200).json({
    ...
    features: [
      {
        id: 'feature_001',
        name: 'Running Data Parsing (跑步数据解析)',
        status: 'implemented',
      ...
      {
        id: 'feature_002',
        name: 'Training Plan Generator (训练计划生成)',
        status: 'implemented',
      ...
      {
        id: 'feature_003',
        name: 'Progress Visualization (进度可视化)',
        status: 'implemented',
      ...
      {
        id: 'feature_005',
        name: 'Training Completion Tracking (训练完成追踪)',
        status: 'implemented',
