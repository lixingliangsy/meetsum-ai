...
function calculateStats(points) {
  ...
  if (timestamps.length > 0) {
    ...
    totalTime = (endDate - startDate) / 1000 // 秒
  }
  ...
  return {
    totalDistance: Math.round(totalDistance * 100) / 100, // 米
    totalDistanceKm: Math.round(totalDistance / 10) / 100, // 公里
    totalElevationGain: Math.round(totalElevationGain * 10) / 10, // 米
    averagePace: averagePace,
    averageSpeed: averageSpeed, // 米/秒
